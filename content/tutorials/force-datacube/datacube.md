...
{{< figure library="true" src="tutorial-datacube-scheme.jpg" title="Overview of the datacube concept in **FORCE**" lightbox="true" >}}
...
{{< figure library="true" src="tutorial-datacube-google-grid.jpg" title="Exported grid loaded in Google Earth" lightbox="true" >}}
...
{{< figure library="true" src="tutorial-datacube-mosaic.jpg" title="VRT mosaick loaded in QGIS" lightbox="true" >}}
